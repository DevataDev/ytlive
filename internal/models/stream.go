...
type Stream struct {
	...
	Status           string         `gorm:"not null" json:"status"`        // "live", "scheduled", "stopped"
	FfmpegPID        *int           `gorm:"default:null" json:"ffmpegPid"` // Optional, for managing ffmpeg process
	...
	// In Stream model:
	StreamMediaFiles []StreamMediaFile `gorm:"foreignKey:StreamID" json:"streamMediaFiles,omitempty"`
}
